#!/usr/bin/env bash
# V3 of the correction-loss variations: adapt only the empty branch (--adapt-null-only).
...
export GPU="${GPU:-0}"
export RUN="${RUN:-v3_adapt_null_only_r16_s0_25}"
