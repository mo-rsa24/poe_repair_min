...
| F2 | fillable | the correction is what is missing: more of it composes more, and two size-matched fakes stay flat | image strip above the three curves, shared λ axis, controls gray | [../../plans/interaction-term/review/03-dose-response.md](../../plans/interaction-term/review/03-dose-response.md), bar answered ✅, re-score owed before the exact percentages are quoted | `dose_curves.png` exists, pre-re-score |
...
Owed by [../../plans/interaction-term/plans/10-figures.md](../../plans/interaction-term/plans/10-figures.md)
(F1 to F7) and [../../plans/animals-compose-transfer/plans/05-figures.md](../../plans/animals-compose-transfer/plans/05-figures.md)
