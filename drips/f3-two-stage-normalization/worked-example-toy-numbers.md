...
> [!aside]
> Every number on this page is invented. None of it is real experimental output. It exists to make the arithmetic in `scripts/make_f3.py` concrete before piece 2 of the F3 explanation continues. The real figure is at [`paper/iclr/figures/F3-size-follows-noise.png`](../../paper/iclr/figures/F3-size-follows-noise.png).
