...
**Nothing has run yet.** This file judges [the design](../plans/tools/04-calibrate-the-measuring-tool.md); answers land
...
| File | What it holds |
|---|---|
| [design](../plans/tools/04-calibrate-the-measuring-tool.md) | the hypothesis, the thresholds, the code to write |
...
**Builds a measuring tool.** A missed threshold does not stop the scope: it forks plan 05 onto its named fallback (shrink, or finish-the-run everywhere), and the verdict is the deliverable either way.
...
Run [the design's tasks](../plans/tools/04-calibrate-the-measuring-tool.md#tasks), then answer the questions above.
