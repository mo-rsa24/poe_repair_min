...
**Nothing has run yet.** This file judges [the design](../plans/02-the-free-probe.md); answers land
...
Run [the design's tasks](../plans/02-the-free-probe.md#tasks), then answer the questions above.
