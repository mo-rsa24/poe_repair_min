...
**Builds a measuring tool.** A missed threshold blocks every plan downstream: the scope's premise is that commitment is a measurable event, and this run is the premise's test.
