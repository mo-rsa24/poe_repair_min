...
|------|------|-------------|
| 46 (previous) | [wire the endpoint predictor](03-wire-the-oracle.md) | the adapter and its one-state check |
...
| 48 (next) | [the grid and the figures](05-the-grid-and-the-figures.md) | the two prompt passes and the paper figures |
...
[The grid and the figures](05-the-grid-and-the-figures.md), on whichever measuring tool this
