...
|------|------|-------------|
| 45 (previous) | [the free test](02-the-free-probe.md) | the first of the two tests, from the cache alone |
...
| 47 (next) | [calibrate the measuring tool](04-calibrate-the-instrument.md) | the 240-state agreement pass |
...
[Calibrate the measuring tool](04-calibrate-the-instrument.md): 240 states, two thresholds, the
