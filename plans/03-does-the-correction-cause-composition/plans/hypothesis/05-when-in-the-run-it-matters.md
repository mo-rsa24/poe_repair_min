...
|------|------|-------------|
| 5 (previous) | ~~[hypothesis-04: what-the-cached-runs-already-show](04-what-the-cached-runs-already-show.md)~~ ✅ | Measured the fork step, step 16, from cached trajectories |
| **6 (current)** | **hypothesis-03: when-in-the-run-it-matters** ◑ | **Answered: the cliff is at the start. The timing tab is still owed** |
| 7 (next) | ~~[hypothesis-05: the-same-story-from-three-sides](06-the-same-story-from-three-sides.md)~~ ✅ | Corroborated the story from three independent measures |

Design only. Verdicts and run state live in
[../review/hypothesis-03-when-in-the-run-it-matters.md](../../review/05-when-in-the-run-it-matters.md).
...
[review file](../../review/05-when-in-the-run-it-matters.md), never in this plan.
...
- Review file, the status source: [../review/hypothesis-03-when-in-the-run-it-matters.md](../../review/05-when-in-the-run-it-matters.md)
...
**When you get results, answer** [the review file](../../review/05-when-in-the-run-it-matters.md)
...
[plans/diagram-prompts.md](../../../diagram-prompts.md), both
...
*(image not yet generated; save under `plans/03-does-the-correction-cause-composition/assets/` and link it here)*
...
Then step 7, [hypothesis-05: the same story from three sides](06-the-same-story-from-three-sides.md), already done.
