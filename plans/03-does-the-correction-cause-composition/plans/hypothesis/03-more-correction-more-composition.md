...
| Step | Plan | Status |
|---|---|---|
| 3 | ~~[building the clean pair pool](../../../04-does-the-fix-reach-unseen-pairs/plans/tools/01-the-clean-pair-pool.md)~~ | ✅ |
| **4 (current)** | **hypothesis-02: more-correction, more-composition** | **⚠️ review ready** |
| 5 | ~~[hypothesis-04: what-the-cached-runs-already-show](04-what-the-cached-runs-already-show.md)~~ | ✅ |
...
**Review questions:** Answered in [../review/hypothesis-02-more-correction-more-composition.md](../../review/03-more-correction-more-composition.md)
...
**When you have results:** Answer the two open questions in the [review file](../../review/03-more-correction-more-composition.md).
...
- Review file: [../review/hypothesis-02-more-correction-more-composition.md](../../review/03-more-correction-more-composition.md) — answers the one question written before the run, and the other checks
...
Once that check passes (verdict: green), proceed to **step 5** [hypothesis-04: what-the-cached-runs-already-show](04-what-the-cached-runs-already-show.md), which reads these outputs without needing GPU.
