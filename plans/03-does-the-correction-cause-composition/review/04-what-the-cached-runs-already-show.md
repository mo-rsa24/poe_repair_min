...
| [the timing answer](05-when-in-the-run-it-matters.md) | the correction moved across nine window positions, which disagrees with the fork step and is not a contradiction |
