...
| File | What it holds |
|---|---|
| [design](../plans/hypothesis-05-the-same-story-from-three-sides.md) | the five checks, their thresholds, and why each shares no machinery with the run across strengths |
