...
- This scope produces no figures. Production stays with the owning scopes:
  `does-the-fix-reach-unseen-pairs/plans/figure-01-the-transfer-figures.md` (A2-A5, feeding register slot F8) and
...
- What exists today: the pooled held-out read from
  `does-the-fix-reach-unseen-pairs/plans/hypothesis-01-does-one-pooled-fix-transfer-at-all.md` (out_out 0.96 at step
  60k). Everything in the does-the-correction-cause-composition cascade is owed; only plan 00, the
  instruments, is complete.
- Two figures in the does-the-correction-cause-composition cascade are illustrative, not measured
...
▶ `/plan-figures` ✅ to lock the narrative spine and the 3-6 load-bearing
   figures, reading from `plans/closing-the-compositional-gap/plans/does-the-fix-reach-unseen-pairs/plans/figure-01-the-transfer-figures.md`
   and `plans/closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/figure-01-the-seven-paper-figures.md`.
