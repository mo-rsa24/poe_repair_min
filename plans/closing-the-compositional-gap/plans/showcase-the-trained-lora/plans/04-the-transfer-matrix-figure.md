...
|------|------|-------------|
| 33 (previous) | [03-the-lora-dose-sweep](03-the-lora-dose-sweep.md) | the causal dose curve |
...
- [ ] **0.1** Run `/verify-plan plans/closing-the-compositional-gap/plans/showcase-the-trained-lora/plans/04-the-transfer-matrix-figure.md`
...
- [ ] **3.2** `/sync-plan-tree plans/closing-the-compositional-gap/plans/showcase-the-trained-lora`
...
```
/run-experiment plans/closing-the-compositional-gap/plans/showcase-the-trained-lora/plans/04-the-transfer-matrix-figure.md — group-pooled training evaluated on concept-disjoint pairs; void any cell sharing a token.
```

▶ `/run-experiment plans/closing-the-compositional-gap/plans/showcase-the-trained-lora/plans/04-the-transfer-matrix-figure.md` ✅
