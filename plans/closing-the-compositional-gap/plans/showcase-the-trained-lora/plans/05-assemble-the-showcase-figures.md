...
- [ ] **0.1** Run `/verify-plan plans/closing-the-compositional-gap/plans/showcase-the-trained-lora/plans/05-assemble-the-showcase-figures.md`
...
- [ ] **4.1** `/sync-plan-tree plans/closing-the-compositional-gap/plans/showcase-the-trained-lora`
- [ ] **4.2** When every plan in the scope is ✅: run `/recap-plan-tree @plans/closing-the-compositional-gap/plans/showcase-the-trained-lora/MASTER_PLAN.md` and record the Artifact URL in the master plan
...
```
Execute plans/closing-the-compositional-gap/plans/showcase-the-trained-lora/plans/05-assemble-the-showcase-figures.md: assemble under the ledger's standard; no sidecar, no ship; wording rules apply to every caption.
```

▶ `/plan-figures plans/closing-the-compositional-gap/plans/showcase-the-trained-lora` ✅ — the set-level pass, if the batch wants re-balancing before import.
...
The scope closes with the recall gallery (task 4.2). The walk that designed this scope is archived at [plans/.walk/showcasing-the-trained-lora.md](../../../../.walk/showcasing-the-trained-lora.md).
