...
|---|---|---|
| 2 of 4 | [building the three-state labelled set](../tools/04-the-three-state-labelled-set.md) | ⚠️ not started |
| **3 of 4** | **this plan** | **⚠️ blocked by the literature check** |
| 4 of 4 | [the promote-or-close decision](../checks/02-promote-or-close.md) | ⚠️ blocked by the other three |

Design only. The verdict lives in [this plan's review file](../../review/03-what-the-current-benchmarks-score.md).
