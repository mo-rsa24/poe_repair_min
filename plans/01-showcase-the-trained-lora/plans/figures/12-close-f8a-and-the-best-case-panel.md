...
**Step 42 in the root running order. Waits on: nothing. Next: [13-revalidate-the-scorer-off-animals](../tools/13-revalidate-the-scorer-off-animals.md).**
...
| 43 (next) | [13-revalidate-the-scorer-off-animals](../tools/13-revalidate-the-scorer-off-animals.md) | Opens tier-three captions |
...
2.3 **Write both verdicts** into the [review file](../../review/12-close-f8a-and-the-best-case-panel.md).
...
**When you get results, answer the open questions in the [review file](../../review/12-close-f8a-and-the-best-case-panel.md).**
...
▶ **Next: [13-revalidate-the-scorer-off-animals](../tools/13-revalidate-the-scorer-off-animals.md).**
...
[13-revalidate-the-scorer-off-animals](../tools/13-revalidate-the-scorer-off-animals.md): the validation round that opens tier-three captions.
