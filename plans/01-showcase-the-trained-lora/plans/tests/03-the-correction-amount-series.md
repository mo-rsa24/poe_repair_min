...
**Step 33 in the root running order. Waits on: step 32 (the dog × dog test is this series' zero-interaction run). Next: [04-the-transfer-matrix-figure](../figures/04-the-transfer-matrix-figure.md).**
...
- **Review questions:** [../review/03-the-lora-dose-sweep.md](../../review/03-the-correction-amount-series.md)
...
▶ **Next: [04-the-transfer-matrix-figure](../figures/04-the-transfer-matrix-figure.md).**
...
[04-the-transfer-matrix-figure](../figures/04-the-transfer-matrix-figure.md): the generalization demo at the reviewer-credible tier.
