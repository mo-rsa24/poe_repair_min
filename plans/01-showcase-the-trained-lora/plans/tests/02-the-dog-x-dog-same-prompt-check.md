...
- **Review questions:** [../review/02-the-dog-x-dog-null-probe.md](../../review/02-the-dog-x-dog-same-prompt-check.md)
...
2.2 **Write the verdict** into the [review file](../../review/02-the-dog-x-dog-same-prompt-check.md) with the counts and the ‖r̂‖ summary.
