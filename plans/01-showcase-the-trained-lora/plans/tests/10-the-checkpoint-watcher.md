...
**Step 40 in the root running order. Waits on: steps 38 and 39 (it watches their checkpoint folders). Next: [11-the-counted-joint-prompt-figure](../figures/11-the-counted-joint-prompt-figure.md).**
...
|------|------|-------------|
| 39 (previous) | [09-experiment-b-rank-16-32](../experiments/09-experiment-b-rank-16-32.md) | The capacity runs it watches |
| **40 (current)** | **10: the-mechanism-follower** | h-space and Jacobian reads per broad checkpoint, each ending in an intervention |
| 41 (next) | [11-the-counted-joint-prompt-figure](../figures/11-the-counted-joint-prompt-figure.md) | The measured baseline figure |
...
- **Review questions:** [../review/10-the-mechanism-follower.md](../../review/10-the-checkpoint-watcher.md)
...
◀ **Needs: nothing to build; [08 task 1.2](../experiments/08-experiment-a-resume-to-200k.md#1--launch-and-harvest) or [09 task 1.2](../experiments/09-experiment-b-rank-16-32.md#1--launch-the-pair)** live before the watch phase.
...
2.2 **Judge each direction by its intervention**: compose rate moved = the figure may enter the main text; unmoved = it stays out (ledger). **Write verdicts** into the [review file](../../review/10-the-checkpoint-watcher.md).
...
**When you get results, answer the open questions in the [review file](../../review/10-the-checkpoint-watcher.md).**
...
▶ **Next: [11-the-counted-joint-prompt-figure](../figures/11-the-counted-joint-prompt-figure.md).**
...
[11-the-counted-joint-prompt-figure](../figures/11-the-counted-joint-prompt-figure.md): the measured joint-prompt baseline, minutes of scoring, independent of everything above.
