...
◀ **Needs: [06 instruction 2.3](06-extend-the-tracking-set.md#2--prove-the-first-short-run-in-wb)** (frozen tracking set proven) and **[01 instruction 2.4](01-read-the-plateau-curves.md#2--read-the-curves-in-wb)** (the ceiling-or-waypoint verdict recorded).
