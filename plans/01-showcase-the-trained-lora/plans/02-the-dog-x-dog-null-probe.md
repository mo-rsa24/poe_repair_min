...
```
/run-experiment plans/01-showcase-the-trained-lora/plans/02-the-dog-x-dog-null-probe.md — identity preflight PoE(A,A) vs Mono(A) first; stop and report if it fails.
```
