...
Nothing has run yet. This file judges [the design](../plans/tests/10-the-checkpoint-watcher.md). Run
...
| File | What it holds |
|---|---|
| [design](../plans/tests/10-the-checkpoint-watcher.md) | the checkpoint watcher, the two reads, the intervention rule |
