...
Nothing has run yet. This file judges [the design](../plans/figures/12-close-f8a-and-the-best-case-panel.md).
...
| File | What it holds |
|---|---|
| [design](../plans/figures/12-close-f8a-and-the-best-case-panel.md) | the tail scoring, the panel, the reconciliation duty |
