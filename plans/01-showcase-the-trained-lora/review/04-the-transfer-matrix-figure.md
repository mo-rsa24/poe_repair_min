...
- [ ] ⚠️ **Was the measuring tool sound?** Scorer contract as everywhere; the audit runs before rendering, and a shared token found afterwards voids that square's reading.
