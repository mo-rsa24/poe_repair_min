...
Nothing has run yet. This file judges [the design](../plans/reading/01-read-where-the-curves-flatten.md); its
answer is the interpretation key for experiments A and B in
[08-experiment-a-resume-to-200k](../plans/experiments/08-experiment-a-resume-to-200k.md) and
[09-experiment-b-rank-16-32](../plans/experiments/09-experiment-b-rank-16-32.md). Run kind:
...
| File | What it holds |
|---|---|
| [design](../plans/reading/01-read-where-the-curves-flatten.md) | what to read, where, and the two verdicts |
...
- [ ] ⚠️ **Was the measuring tool sound?** `eval/frac_distance_reached` came from the wiring built in
  ...
  [that review file](../../04-does-the-fix-reach-unseen-pairs/review/02-three-live-curves-while-training.md).
