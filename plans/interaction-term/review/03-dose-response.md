...
Verdicts for [../plans/03-dose-response.md](../plans/03-dose-response.md). The design lives there
...
- [x] 🟡 Does the scorer's instance count mean what the rule says it means?
      ...
      Next action: [../procedures/03-rescore-the-dose-sweep.md](../procedures/03-rescore-the-dose-sweep.md)
...
- [ ] ⚠️ Do the curves hold after re-scoring on a pinned root and a chosen confidence floor?
      ...
      [../procedures/03-rescore-the-dose-sweep.md](../procedures/03-rescore-the-dose-sweep.md).
