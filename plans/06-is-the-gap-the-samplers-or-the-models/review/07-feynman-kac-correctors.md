...
[the Feynman-Kac design](../plans/ideas/07-feynman-kac-correctors.md). If
[the measurement at step 26](03-what-is-left-once-the-chain-settles.md) returns a null,
...
| File | What it holds |
|---|---|
| [design](../plans/ideas/07-feynman-kac-correctors.md) | what must pass first, the read, the cost estimate, and the built-or-cited decision |
| **this file** | **the verdict: not yet run** |
| [the step 26 verdict](03-what-is-left-once-the-chain-settles.md) | whether this plan runs at all |
| [the amount-axis verdict](06-three-rules-on-one-amount-axis.md) | whether the corrector rows are worth extending to a second family |
