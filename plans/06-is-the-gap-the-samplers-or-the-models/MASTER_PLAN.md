...
| 27 | [does the corrector compose in the same window](plans/hypothesis/04-does-the-corrector-compose-in-the-same-window.md) | tests the claim | the same nine window positions rerun with the corrector in place of the injected correction, matched to the existing figure | 26 | ◑ running 2026-09-06 at `c = 3`, `k = 20`, recorded as run against an inconclusive step 26; the eight-seed sheets and the tail condition run with it |
