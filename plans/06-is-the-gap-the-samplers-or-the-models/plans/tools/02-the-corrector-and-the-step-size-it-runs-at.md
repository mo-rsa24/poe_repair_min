...
| 26 | [hypothesis-02: what-is-left-once-the-chain-settles](../hypothesis/03-what-is-left-once-the-chain-settles.md) ⚠️ | the measurement everything downstream waits on, which cannot be believed unless this plan passed |
| 29 | [baseline-02: three-rules-on-one-amount-axis](../baselines/06-three-rules-on-one-amount-axis.md) ⚠️ | needs the composer built here to produce its two corrector rows |

Design only. Verdicts and run state live in
[the paired review file](../../review/02-the-corrector-and-the-step-size-it-runs-at.md).
...
**Associated materials.** [The review questions](../../review/02-the-corrector-and-the-step-size-it-runs-at.md),
...
- The search runs in-session rather than under Slurm, because it is short. The rule that biggpu
  allows one job per user bites at [step 26](../hypothesis/03-what-is-left-once-the-chain-settles.md),
...
▶ **Next: [step 26's task 1.1](../hypothesis/03-what-is-left-once-the-chain-settles.md#1--write-the-gate-script-with-its-bars-in-source)**,
...
|---|---|
| the picked `c` | [what is left once the chain settles](../hypothesis/03-what-is-left-once-the-chain-settles.md) and [three rules on one amount axis](../baselines/06-three-rules-on-one-amount-axis.md), both of which run the composer at this value |
...
[Step 26, what is left once the chain settles](../hypothesis/03-what-is-left-once-the-chain-settles.md).
