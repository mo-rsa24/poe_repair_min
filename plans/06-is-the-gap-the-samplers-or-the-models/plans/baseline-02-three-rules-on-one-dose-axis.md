...
[step 30](idea-01-feynman-kac-correctors-gated.md), which runs only if the corrector rows here
moved something.
...
|---|---|
| the `λ=1` classification | the review file, then [step 30](idea-01-feynman-kac-correctors-gated.md), which reads it to decide whether it runs |
...
[Step 30, the Feynman-Kac correctors](idea-01-feynman-kac-correctors-gated.md). It runs only if
