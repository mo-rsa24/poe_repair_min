...
have received more.
[The timing plan in the causal scope](../../03-does-the-correction-cause-composition/plans/hypothesis-03-when-in-the-run-it-matters.md)
...
- [ ] **1.3** Decide and record how the different absolute amounts per row are handled.
  - Either put the delivered absolute total on each row's label, or run the `--mode matched` arm
    ...
    which [the timing plan](../../03-does-the-correction-cause-composition/plans/hypothesis-03-when-in-the-run-it-matters.md)
