...
|------|------|-------------|
| 24 | [hypothesis-01: the-free-bound-on-the-models-share](01-the-free-bound-on-the-models-share.md) ⚠️ | the lower bound this plan's answer is read against |
| 25 | [instrument-01: the-corrector-and-the-step-size-it-runs-at](../tools/02-the-corrector-and-the-step-size-it-runs-at.md) ⚠️ | the composer and the `c` this plan runs at |
...
| 27 | [hypothesis-03: does-the-corrector-compose-in-the-same-window](04-does-the-corrector-compose-in-the-same-window.md) ⚠️ | waits on this, softly |
...
[the paired review file](../../review/03-what-is-left-once-the-chain-settles.md).
...
**Associated materials.** [The review questions](../../review/03-what-is-left-once-the-chain-settles.md),
...
by [step 25](../tools/02-the-corrector-and-the-step-size-it-runs-at.md), and nothing else. Same
...
- **Inconclusive.** The ratio still moves by more than `MAX_K_INSTABILITY = 0.05` between `k=100`
  ...
  itself. Return to [step 25](../tools/02-the-corrector-and-the-step-size-it-runs-at.md) and widen
...
and [the two literature checks before print](../../../03-does-the-correction-cause-composition/plans/checks/09-two-literature-checks-before-print.md)
...
repeated in [the review file](../../review/03-what-is-left-once-the-chain-settles.md) and
...
[step 27](04-does-the-corrector-compose-in-the-same-window.md) and is a behavioural
...
1. **`scripts/corrector_residual_curve.py`.** Carries the five thresholds as module-level constants,
   ...
   It is also the script [step 25](../tools/02-the-corrector-and-the-step-size-it-runs-at.md)
...
[the review file](../../review/03-what-is-left-once-the-chain-settles.md).
...
| Path | Why it is read |
|---|---|
| `poe_repair/composers/poe_langevin.py` | the composer [step 25](../tools/02-the-corrector-and-the-step-size-it-runs-at.md) builds, run here at six values of `k` |
...
[Step 27, does the corrector compose in the same window](04-does-the-corrector-compose-in-the-same-window.md).
...
[step 25 task 2.1](../tools/02-the-corrector-and-the-step-size-it-runs-at.md#2--fix-the-step-size-before-anything-is-read).
