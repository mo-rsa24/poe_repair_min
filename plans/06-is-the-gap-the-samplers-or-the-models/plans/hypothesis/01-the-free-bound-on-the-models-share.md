...
| 25 | [instrument-01: the-corrector-and-the-step-size-it-runs-at](../tools/02-the-corrector-and-the-step-size-it-runs-at.md) ⚠️ | builds the corrector this bound caps the value of |
| 26 | [hypothesis-02: what-is-left-once-the-chain-settles](03-what-is-left-once-the-chain-settles.md) ⚠️ | the run the rest of the scope waits on, which reads its own result against this lower bound |

Design only. Verdicts and run state live in
[the paired review file](../../review/01-the-free-bound-on-the-models-share.md).
...
**Associated materials.** [The review questions](../../review/01-the-free-bound-on-the-models-share.md),
...
[the review file](../../review/01-the-free-bound-on-the-models-share.md). No figure, no
...
- [ ] **0.2** Re-read [the timing verdict](../../../03-does-the-correction-cause-composition/review/05-when-in-the-run-it-matters.md).
  ...
  - Done when: each of the three is found in that file, or the difference is written into
    [the review file](../../review/01-the-free-bound-on-the-models-share.md). If any has
...
- [ ] **1.1** Read the per-step correction size as the run approaches zero noise.
  ...
  - **The seeds here are 4, 42 and 123**, on `a_cat__x__a_dog` and
    `a_butterfly__x__a_flower_meadow`. [Step 26, what is left once the chain settles](03-what-is-left-once-the-chain-settles.md),
...
[step 25, the corrector and the step size it runs at](../tools/02-the-corrector-and-the-step-size-it-runs-at.md),
...
[the review file](../../review/01-the-free-bound-on-the-models-share.md).
...
| the lower bound is measured | the reading of the curve at [step 26](03-what-is-left-once-the-chain-settles.md), which is judged against this number |
