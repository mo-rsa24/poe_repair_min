...
| 29 | [baseline-02: three-rules-on-one-amount-axis](06-three-rules-on-one-amount-axis.md) ⚠️ | needs the per-step prediction this plan exposes |

Design only. Verdicts and run state live in
[the paired review file](../../review/05-superdiff-at-this-repos-fifty-steps.md).
...
**Associated materials.** [The review questions](../../review/05-superdiff-at-this-repos-fifty-steps.md),
...
- biggpu allows one job per user. The two parity renders are short enough to run in-session; the
  `nohup`-outside-Slurm rule bites at [step 29](06-three-rules-on-one-amount-axis.md). Read
...
[the review file](../../review/05-superdiff-at-this-repos-fifty-steps.md).
...
|---|---|
| the parity verdict | every caption at [step 29](06-three-rules-on-one-amount-axis.md) that compares against SuperDiff |
