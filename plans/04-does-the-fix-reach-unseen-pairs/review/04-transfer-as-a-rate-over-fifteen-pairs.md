...
[the plan that holds out each pair in turn](../plans/hypothesis/04-transfer-as-a-rate-over-fifteen-pairs.md),
...
[the three live curves during training](02-three-live-curves-while-training.md) is
...
| File | What it holds |
|---|---|
| [design](../plans/hypothesis/04-transfer-as-a-rate-over-fifteen-pairs.md) | the fifteen leave-one-pair-out runs, the held-out set, the threshold |
| **this file** | **the verdict: transfer as a rate over fifteen held-out pairs** |
| [what must pass first](02-three-live-curves-while-training.md) | the one-epoch first run that must be green before this starts |
| [what defends it](05-the-size-matched-control-pool.md) | the size-matched pool that rules out data volume |
...
| whether it is safe to launch fifteen unattended runs | the one-epoch first run in [the three live curves plan](02-three-live-curves-while-training.md) going green | the launch itself |

## Next step

Navigation: ⬅️ [Still open](#still-open) | 📋 [TOC](#table-of-contents)

Get the one-epoch first run in [the three live curves plan](02-three-live-curves-while-training.md)
