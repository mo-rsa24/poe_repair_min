...
[the plan that builds the transfer figures](../plans/figures/06-the-transfer-figures.md), whose
...
| File | What it holds |
|---|---|
| [design](../plans/figures/06-the-transfer-figures.md) | the six figures, their panels, and what each is for |
...
| A5 | step 12 landing | the pool-contrast argument, which is what [baseline-01](05-the-size-matched-control-pool.md) supplies |
