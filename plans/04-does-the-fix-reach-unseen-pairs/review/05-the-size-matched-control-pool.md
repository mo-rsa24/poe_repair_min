...
[../plans/baseline-01-the-size-matched-control-pool.md](../plans/baselines/05-the-size-matched-control-pool.md),
...
| File | What it holds |
|---|---|
| [design](../plans/baselines/05-the-size-matched-control-pool.md) | how the mixed pool is built, and what is held identical between the two |
| **this file** | **the verdict: whether the animals pool beat a pool of the same size** |
| [the claim this defends](04-transfer-as-a-rate-over-fifteen-pairs.md) | the transfer rate this control makes attributable |
...
Build the mixed pool per [the design](../plans/baselines/05-the-size-matched-control-pool.md), then
