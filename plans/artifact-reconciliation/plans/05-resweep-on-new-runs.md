...
- [ ] ⚠️ Append a decision-timeline gate for each new landing to `docs/DECISION_TIMELINE.md` (append-only; supersede with a banner, never rewrite) so the spine stays current.
