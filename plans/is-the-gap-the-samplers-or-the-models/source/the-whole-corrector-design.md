...
|------|------|-------------|
| 6 | [hypothesis-03: when-in-the-run-it-matters](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/hypothesis-03-when-in-the-run-it-matters.md) ◑ | Found the cliff at steps 0 to 10, which is also where a sampler artifact would live |
| 15 | [gate-01: two-literature-checks-before-print](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/gate-01-two-literature-checks-before-print.md) ⚠️ | Already cites Soiffer et al. as the reason to train a fix rather than trust a sampler. This scope is the measurement behind that sentence |
...
| 21 | [writing-06: mechanism-and-limitations](../../closing-the-compositional-gap/plans/writing-the-paper/plans/writing-06-mechanism-and-limitations.md) ⚠️ | Cannot be written honestly until step 26 returns a size |
...
[the timing verdict](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/review/hypothesis-03-when-in-the-run-it-matters.md), which also records
...
[gate-01](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/gate-01-two-literature-checks-before-print.md) already cites the paper that raises it.
...
- [ ] **0.1** Re-read [the timing verdict](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/review/hypothesis-03-when-in-the-run-it-matters.md)
...
- [ ] **7.4** Handle the two things this grid is known to hit rather than discovering them. The
      ...
      [The timing plan](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/hypothesis-03-when-in-the-run-it-matters.md) met this and answered it with
...
- [ ] **C.3** Update
      [gate-01](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/gate-01-two-literature-checks-before-print.md) with the measured size, since it
...
- [ ] **11.2** For grid one, count composed cells per row by eye and compare against the detector's
      count. [The timing verdict](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/review/hypothesis-03-when-in-the-run-it-matters.md) records
...
[generalization-01](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/generalization-01-other-models-and-samplers.md). That plan varies the
...
|---|---|
| the gate's verdict | the review file, then [gate-01](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/gate-01-two-literature-checks-before-print.md), which currently cites a paper for a claim this makes into a number |
...
| the plan's status | the scope [MASTER_PLAN.md](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/MASTER_PLAN.md) table and the root running order, both by `sync-plan-tree` rather than by hand |
