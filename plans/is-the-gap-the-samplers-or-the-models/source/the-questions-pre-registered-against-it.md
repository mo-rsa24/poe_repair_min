...
| [the timing verdict](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/review/hypothesis-03-when-in-the-run-it-matters.md) | the result this plan puts under threat, and the numbers it quotes |
| [the print gate](../../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/gate-01-two-literature-checks-before-print.md) | cites Soiffer et al. for the claim this plan turns into a number |
