...
[The timing plan](../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/hypothesis-03-when-in-the-run-it-matters.md)
...
[writing-06](../closing-the-compositional-gap/plans/writing-the-paper/plans/writing-06-mechanism-and-limitations.md)
...
12. The scope has a recall gallery: run `/recap-plan-tree @plans/is-the-gap-the-samplers-or-the-models/MASTER_PLAN.md`
...
| The rows deliver different absolute amounts at the same `λ`, because `‖r_t^M‖` differs per row. [The timing plan](../closing-the-compositional-gap/plans/does-the-correction-cause-composition/plans/hypothesis-03-when-in-the-run-it-matters.md) met this and answered it with a `--mode matched` arm, so either put the delivered total on each row label or run matched | step 29 |
