...
|---|---|---|---|
| `interaction_term/` | 3.4G | does-the-correction-cause-composition plans 03/04/05 | **live**: F2 cells, fork paths, window grids land here |
...
| `manifold_cache/` (symlink into `artifacts/`) | | does-the-correction-cause-composition plan 06 | **supporting**: the CLIP axes for the manifold slide |
