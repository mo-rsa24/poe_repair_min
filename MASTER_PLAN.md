...
| 56 | 06-is-the-gap-the-samplers-or-the-models/baseline-07-feynman-kac-steering-on-top-of-the-rank-32-correction | the same steering with the rank-32 step-30050 correction in the proposal at λ 0.5 and 1.2, K 16, seeds 9 to 16, judged at λ 0.5 against the adapter alone; asks whether selection adds anything once the model-side fix puts composing states in reach; ImageReward breaks ties so the cleanest two-animal particle is kept | ◑ running since 2026-09-06 03:24 as Slurm job 50332 on mscluster52 (W&B `dfrceppl`) | 55 |
