...
|---|---|---|
| `paper/iclr/figures/compose-rate-as-correction-rises.png` | F2, the headline dose figure | result stands (the true correction takes compose rate from 7% to 93%, the controls stay flat); the exact percentages wait on the re-score; **caption owed** |
