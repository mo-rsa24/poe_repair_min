...
Equivalent to::
    ...
    python -m poe_repair.experiments.residual_between_mono_and_poe.existence
...
from poe_repair.experiments.residual_between_mono_and_poe.existence.main import (
    main as existence_main,
)
from poe_repair.experiments.residual_between_mono_and_poe.clip_window.main import (
