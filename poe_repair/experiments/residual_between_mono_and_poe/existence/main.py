...
Three stages, each independently re-runnable:
    ...
    python -m poe_repair.experiments.residual_between_mono_and_poe.existence                  # all stages
    python -m poe_repair.experiments.residual_between_mono_and_poe.existence --skip-sweep    # metrics + figures
    python -m poe_repair.experiments.residual_between_mono_and_poe.existence --skip-sweep --skip-metrics
                                                                # figures only
    python -m poe_repair.experiments.residual_between_mono_and_poe.existence --only-lambdas 0.0,0.5,1.0
                                                                # smoke run
"""
...
from poe_repair.experiments.residual_between_mono_and_poe import sweep as S
from poe_repair.experiments.residual_between_mono_and_poe.existence import figures as F
