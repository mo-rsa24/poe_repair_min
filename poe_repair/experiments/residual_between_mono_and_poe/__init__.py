...
Entry points::
    ...
    python -m poe_repair.experiments.residual_between_mono_and_poe                 # both
    python -m poe_repair.experiments.residual_between_mono_and_poe.existence       # one
    python -m poe_repair.experiments.residual_between_mono_and_poe.clip_window     # one
"""
