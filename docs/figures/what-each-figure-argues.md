...
**Built.** `python scripts/make_f1.py` → `paper/iclr/figures/what-the-product-misses-explainer.pdf`.
...
**Built.** `python scripts/make_f2.py` → `paper/iclr/figures/compose-rate-as-correction-rises.pdf`.
...
**Built.** `python scripts/make_f3.py` → `paper/iclr/figures/correction-size-over-the-denoising-run-across-17-pairs.pdf`.
