...
| *new* Learned-vs-true [cosine](/home-mscluster/mmolefe/goal-setting/learning/spectral-structure-of-the-correction/plans/01-dot-product-norm-cosine.md) at sampling steps 7, 15, 22 | to be wired | Same idea as `direction_cosine` but against this example's own true correction at three fixed sampling steps. Shows which part of the trajectory is learned first. |
